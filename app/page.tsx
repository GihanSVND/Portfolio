...
export default function Home() {
    ...
    <div className="bg-black">
      ...
      <div className="flex flex-col justify-center items-center h-screen relative ">
        ...
        <div className="transform -translate-y-[-680px] z-40">
          <svg className="animate-bounce w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
      ...
      <div className="flex flex-col translate-y-[-120px] justify-center items-center relative ">
        <h1 className={`${poppins5.className} absolute text-[200px] font-extrabold text-gray-300`}>
            Time Line
            <span className="text-[#FF4401]">.</span>
          </h1>
        </div>
        ...
        <div className="absolute w-4 h-4 bg-[#FF4401] rounded-full left-1/2 transform -translate-x-1/2"></div>
          <div className="flex justify-start pr-10 translate-x-[-300px]">
            <div className="bg-[#18181b] border-[1px] border-white text-white p-8 w-[400px] h-[150px]  rounded-[30px] shadow-lg">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-20 pr-5">
                <path fill-rule="evenodd" d="M2.25 5.25a3 3 0 0 1 3-3h13.5a3 3 0 0 1 3 3V15a3 3 0 0 1-3 3h-3v.257c0 .597.237 1.17.659 1.591l.621.622a.75.75 0 0 1-.53 1.28h-9a.75.75 0 0 1-.53-1.28l.621-.622a2.25 2.25 0 0 0 .659-1.59V18h-3a3 3 0 0 1-3-3V5.25Zm1.5 0v7.5a1.5 1.5 0 0 0 1.5 1.5h13.5a1.5 1.5 0 0 0 1.5-1.5v-7.5a1.5 1.5 0 0 0-1.5-1.5H5.25a1.5 1.5 0 0 0-1.5 1.5Z" clip-rule="evenodd" />
              </svg>

                <div>
                  <h3 className={`${poppins7.className} text-[30px] font-bold text-[#FF4401]`}>Co-Founder</h3>
          ...
          <div className="flex justify-start pr-10 translate-x-[350px]">
            <div className="bg-[#18181b] border-[1px] border-white text-white p-8 w-[400px] h-[150px]  rounded-[30px] shadow-lg">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-20 pr-5">
                ...
                <div>
                  <h3 className={`${poppins7.className} text-[30px] font-bold text-[#FF4401]`}>3D Artist</h3>
  ...
  <path fill-rule="evenodd" d="M1.5 6a2.25 2.25 0 0 1 2.25-2.25h16.5A2.25 2.25 0 0 1 22.5 6v12a2.25 2.25 0 0 1-2.25 2.25H3.75A2.25 2.25 0 0 1 1.5 18V6ZM3 16.06V18c0 .414.336.75.75.75h16.5A.75.75 0 0 0 21 18v-1.94l-2.69-2.689a1.5 1.5 0 0 0-2.12 0l-.88.879.97.97a.75.75 0 1 1-1.06 1.06l-5.16-5.159a1.5 1.5 0 0 0-2.12 0L3 16.061Zm10.125-7.81a1.125 1.125 0 1 1 2.25 0 1.125 1.125 0 0 1-2.25 0Z" clip-rule="evenodd" />
                ...
                <div>
                  <h3 className={`${poppins7.className} text-[30px] font-bold text-[#FF4401]`}>Logo Designer</h3>
                  <p className={`${poppins4.className} text-sm`}>CrewGen - Full time</p>
